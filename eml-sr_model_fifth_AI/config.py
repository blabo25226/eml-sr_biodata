...
# eml-sr_fable (see eml-sr_fable/manual_eml-sr_fable.md)
FABLE_MAX_COMPLEXITY = 6
FABLE_COMPLEXITY_PENALTY = 0.08
FABLE_BEAM_WIDTH = 1000
FABLE_TIME_BUDGET_S = 180.0
FABLE_SUBSAMPLE_SIZE = 256
FABLE_EARLY_EXIT_THRESHOLD = 9e-3  # noisy / small n
FABLE_REFINEMENT_TOP_K = 8
FABLE_MAX_BOOST_TERMS = 6
FABLE_CONSERVATIVE_BAND = 1.05

PREPROCESS_R = ROOT / "replicate_paper_enet.R"
